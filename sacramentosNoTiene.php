			...
			<div class="rightcolumn">
				<div class="menu">
					<table>
						...
						<tbody>
							<?php	
								while($filaNoTiene = mysqli_fetch_assoc($resultadoNoTiene)){
							?>
							<tr>
								<!-- <td> <?php //echo $$filaNoTiene['mejinos_id'] ?> </td>--> 
								<td> <?php echo $filaNoTiene['mejinos_apellido'] ?> 	</td>
								<td> <?php echo $filaNoTiene['mejinos_nombre'] ?>		</td>
								<td> <?php echo $filaNoTiene['mejinos_fechaNac'] ?>	</td>
								<td> <?php echo $filaNoTiene['edad'] ?> 	</td> <!-- LINEA AGREGADA POR QUERY--> 
								<td> 
									<?php 
									//echo $filas['mejinos_etapa'] 
									switch ($filaNoTiene['mejinos_etapa']){
								...
								<td> 
									...
									switch ($filaNoTiene['mejinos_comunidad']){
								...
								<td> 
									...
									switch ($filaNoTiene['mejinos_sacramento']){
