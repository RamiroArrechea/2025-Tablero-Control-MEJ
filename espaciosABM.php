			...
			<div class="rightcolumn">
				<div id="cajaLista">
					<ul id="cajaLista">
						...
						<div class='logCenter'><b><u> ABM - (AGREGAR - MODIFICAR- BORRAR)</u></b></div>					
					</ul>
				</div>
						...
						<tbody>
							...
							?>
								<tr> <!--Cada TR es una fila en la tabla -->
									<td> <?php echo $filas['espacio_nombre'] ?> </td>
									
									<td>
										<?php 
										echo "<a href='./espaciosABM_Modificar.php?id=".$filas['espacio_id']."'>EDITAR</a>"; ?>
										-
										<?php 
										echo "<a href='./espaciosABM_Eliminar.php?id=".$filas['espacio_id']."'>ELIMINAR</a>"; ?>
									</td>
								</tr>
							...
							<td><!----------FORMULARIO DE ENVIO ------------------------>
								<form method="post" action="./conexion/conexionEspaciosABM.php" >			
									<table >
										<tr>
											<td>
											<p>Agregue un nuevo espacio.</p>
											</td>
										</tr>
										<tr>
											<td>
												<p>Nombre del Espacio nuevo:</p>
											</td>												
											<td>
												<input type= "text" name="nombreEspacio" required oninput="let p=this.selectionStart;
