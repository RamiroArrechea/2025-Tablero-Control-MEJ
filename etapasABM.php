			...
			<div class="rightcolumn">
				<div id="cajaLista">
					<ul id="cajaLista">
						...
						<div class='logCenter'><b><u> ETAPAS MEJ</u></b></div>
					</ul>
				</div>
						...
						<tbody>
							...
							?>
								<tr> <!--Cada TR es una fila en la tabla -->
									<td> <?php echo $filas['etapa_nombre'] ?> </td>
					...
					<tbody>
						<tr>
							<td><!----------FORMULARIO DE ENVIO ------------------------>
								<form method="post" action="./conexion/conexionEtapasABM.php" >			
									<table >
										<tr>
											<td>
										...
										<tr>
											...
											<td>
												<input type= "text" name="nombreEtapa" required oninput="let p=this.selectionStart;
