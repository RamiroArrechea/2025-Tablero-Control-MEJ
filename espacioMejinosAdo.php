				...
				<div id="navvy">
					<ul id="navvylist">
						...
						<li><?php		//
							...
							$d0->setHref("./espaciosMej.php"); //el dia de mañana reemplazar por COMUNIDAD
							$d0->show();
							?>
						</li>
			...
			<div class="rightcolumn">
				<div class="menu">
					<table>
						...
						<tbody>
							<?php	
								while($filaAdo = mysqli_fetch_assoc($resultadoAdo)){
							?>
							<tr>
								<!-- <td> <?php //echo $filaJunior['mejinos_id'] ?> </td>--> 
								<td> <?php echo $filaAdo['mejinos_apellido'] ?> </td>
								<td> <?php echo $filaAdo['mejinos_nombre'] ?> 	</td>
								<td> <?php echo $filaAdo['mejinos_fechaNac'] ?> </td>
								<td> <?php echo $filaAdo['edad'] ?> </td> <!-- LINEA AGREGADA POR QUERY--> 
								<td> 
									<?php 
									//echo $filas['mejinos_etapa'] 
									switch ($filaAdo['mejinos_etapa']){
								...
								<td> 
									...
									switch ($filaAdo['mejinos_comunidad']){
								...
								<td> 
									...
									switch ($filaAdo['mejinos_sacramento']){
