...
<?php
	...
	$_SESSION['NUM_MEJINOS'] = mysqli_num_rows($resultadoBautismo);
			...
			<div class="rightcolumn">
				<div class="menu">
					<table>
						...
						<tbody>
							<?php	
								while($filaBaustimo = mysqli_fetch_assoc($resultadoBautismo)){
							?>
							<tr>
								<!-- <td> <?php //echo $$filaNoTiene['mejinos_id'] ?> </td>--> 
								<td> <?php echo $filaBaustimo['mejinos_apellido'] ?> 	</td>
								<td> <?php echo $filaBaustimo['mejinos_nombre'] ?>		</td>
								<td> <?php echo $filaBaustimo['mejinos_fechaNac'] ?>	</td>
								<td> <?php echo $filaBaustimo['edad'] ?> 	</td> <!-- LINEA AGREGADA POR QUERY--> 
								<td> 
									<?php 
									//echo $filas['mejinos_etapa'] 
									switch ($filaBaustimo['mejinos_etapa']){
								...
								<td> 
									...
									switch ($filaBaustimo['mejinos_comunidad']){
								...
								<td> 
									...
									switch ($filaBaustimo['mejinos_sacramento']){
